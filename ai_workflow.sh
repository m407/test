...
run_stage() {
  ...
  for agent in "${agents[@]}"; do
    ...
    local prompt
    prompt=$(printf 'You are an expert for stage "%s". %s\n\n%s\n' "$stage_name" "$review_instructions" "$content")
...
EOT
STAGE1_REVIEW="Check completeness and correctness of the analysis. Correct or clarify the data in the MD document."
...
EOT
STAGE2_REVIEW="Check the relevance and validity of the found examples. Add missing solutions or remove unnecessary ones."
...
EOT
STAGE3_REVIEW="Check the completeness of scenarios. Correct inaccurate formulations."
...
EOT
STAGE4_REVIEW="Review architectural decisions. Correct or clarify diagrams and APIs."
...
EOT
STAGE5_REVIEW="Check code compliance with standards. Clarify descriptions, add important points."
...
EOT
STAGE6_REVIEW="Check the informativeness of logs and metrics. Adjust levels and formats."
...
Additional information.
EOT
STAGE7_REVIEW="Check compliance with requirements. Correct violations."
...
EOT
STAGE8_REVIEW="Check the README for relevance. Correct wording."
